...
public class Constants {
    ...
    public final static String SERVER_HOST = "121.42.29.124";
    public final static String SERVER_URL = "http://"+SERVER_HOST+":9090/plugins/xmppservice/";
    public static String SERVER_NAME = "iz28bn738dcz";
 ...
 //   public final static String SAVE_IMG_PATH = PATH + "/images";//设置保存图片文件的路径
  //  public final static String SAVE_SOUND_PATH = PATH + "/sounds";//设置声音文件的路径
     ...
     * 接受新消息
     */
    public final static String RECEIVER_NEWMESSAGE = "newmessage";
    /**
     * 新会话
     */
    public final static String RECEIVER_NEWDIALOGUE = "newdialogue";
}
